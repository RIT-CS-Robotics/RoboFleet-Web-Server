# 🚨 RoboFleet Safety & Malfunction Protocols

> **CRITICAL:** All developers and researchers should read and understand this document before deploying code to any physical hardware. Hardware robotics can cause physical injury and property damage if improperly handled.
...
* **Starting Location:** Make sure that the robot is in the starting location that it has saved in its navigation systems. Starting from random places will make the robot lost and can cause unexpected behavior.
...
3. **Notify the Lab:** Inform the supervising professor or the lead student worker immediately.
4. **Log the Bug:** Create a log of the issue in whatever format and whatever place your lab does these types of things.
